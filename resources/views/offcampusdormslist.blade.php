<html>
        ...
        <div class="topnav" id="myTopnav">
            ...
            <div class="menu">
                <img style="float:right;" src="/images/user.png"  width="15%" height="35%">
                    <ul><li>
                    <a href="#" style="float:right;width:10vw;width:10vw;">{{ Auth::user()->stud_num }}</a>
    ...
    <div class="page__section">
        <nav class="breadcrumb breadcrumb_type5" aria-label="Breadcrumb">
            <ol class="breadcrumb__list r-list">
              ...
              <li class="breadcrumb__group">
                <span class="breadcrumb__point" aria-current="page">Off Campus</span>
              </li>
            </ol>
        </nav>
    </div>         
    ...
    <div class="header"> <h1>LIST OF DORMITORIES</h1>
        ...
        @csrf
          ...
          <button type="submit"><img src="https://img.icons8.com/pastel-glyph/50/000000/search--v2.png" width="70%"></button>
        </form>         
    </div>
